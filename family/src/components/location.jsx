...
const Location = (props) => {
    return ( 
        <div className="location">
            ...
            <p>The party will be on Saturday, December 28, 2019 from 2:00pm until whenever.</p>
